...
ID3D12Device* Object2dInstancing::device_ = nullptr;
ID3D12GraphicsCommandList* Object2dInstancing::commandList_ = nullptr;
ComPtr<ID3D12RootSignature> Object2dInstancing::rootSignature_;
ComPtr<ID3D12PipelineState> Object2dInstancing::graphicsPipelineState_;

void Object2dInstancing::StaticInitialize(ID3D12Device* device, int windowWidth, int windowHeight) {
	...
	descriptorRangeInstancing[0].BaseShaderRegister = 1; //1から始まる
	...
	rootParameters[RootParameter::kForVS].ShaderVisibility = D3D12_SHADER_VISIBILITY_VERTEX; //VertexShaderで使う
	rootParameters[RootParameter::kForVS].DescriptorTable.pDescriptorRanges = descriptorRangeInstancing; //Tableの中身の配列を指定
	rootParameters[RootParameter::kForVS].DescriptorTable.NumDescriptorRanges = _countof(descriptorRangeInstancing); //Tableで利用する数
	...
	//Shaderをコンパイルする
	ComPtr<IDxcBlob> verterShaderBlob = CompileShader(L"Resources/shaders/Object2dInstancing.VS.hlsl", L"vs_6_0", dxcUtils, dxcCompiler, includeHandler);
	assert(verterShaderBlob != nullptr);

	ComPtr<IDxcBlob> pixelShaderBlob = CompileShader(L"Resources/shaders/Object2dInstancing.PS.hlsl", L"ps_6_0", dxcUtils, dxcCompiler, includeHandler);
...
void Object2dInstancing::preDraw(ID3D12GraphicsCommandList* commandList) {
...
void Object2dInstancing::postDraw() {
...
void Object2dInstancing::Init(uint32_t instanceMax) {

	instanceMax_ = instanceMax;
...
void Object2dInstancing::SetSize(const Vector2& size) {
...
void Object2dInstancing::SetScale(float scale) {
...
void Object2dInstancing::SetScale(const Vector2& scale) {
...
void Object2dInstancing::SetAnchorpoint(const Vector2& anchorpoint) {
...
void Object2dInstancing::SetColor(const Vector4& color) {
...
ComPtr<ID3D12Resource> Object2dInstancing::CreateBufferResource(ID3D12Device* device, size_t sizeInBytes) {
...
ComPtr<IDxcBlob> Object2dInstancing::CompileShader(const std::wstring& filePath, const wchar_t* profile, IDxcUtils* dxcUtils, IDxcCompiler3* dxcCompiler, IDxcIncludeHandler* includeHandleer) {
